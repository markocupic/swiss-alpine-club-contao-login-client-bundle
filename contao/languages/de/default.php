...
$GLOBALS['TL_LANG']['ERR']['sacOidcLoginError_invalidState_howToFix'] = 'Probiere dich nochmals einzuloggen.';
...
$GLOBALS['TL_LANG']['ERR']['sacOidcLoginError_unexpectedError_howToFix'] = 'Probiere dich nochmals einzuloggen.';
